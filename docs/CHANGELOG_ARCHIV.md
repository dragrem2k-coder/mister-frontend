# Changelog — Archiv (ausführlich)

Das ist die vollständige Fassung mit allen Build-Einträgen seit v1.1.
Hier steht nicht nur *was* geändert wurde, sondern auch warum, was
dabei schiefging und was gemessen wurde.
...
Kurzer Überblick mit Screenshots: `notizen/VORSCHAU.md`.
