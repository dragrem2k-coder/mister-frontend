# Dragend — Handbuch (ausführlich)

Das ist die vollständige Beschreibung aller Funktionen. Die kurze
Übersicht steht in der [README](../README.md) im Wurzelverzeichnis.
...
Kompakter Überblick zusätzlich in `notizen/VORSCHAU.md`.
...
Authentifizierung. Technische Details: `notizen/STREAM_fuer_Dragrem.md`.
...
`notizen/STREAM_fuer_Dragrem.md` für die Einzelheiten), zeigt dieses Feature
