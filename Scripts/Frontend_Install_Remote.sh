...
#
#   wget -qO- https://raw.githubusercontent.com/dragrem2k-coder/mister-frontend/main/Scripts/Frontend_Install_Remote.sh | bash
#
...
# "install.sh" - jetzt umbenannt, siehe Kopfkommentar in
# Frontend_Install.sh fuer die Begruendung (einheitliches
# "Frontend_"-Praefix fuer alle eigenen Scripts).
# ============================================================
...
# BUGFIX (siehe Scripts/Frontend_Install.sh fuer die ausfuehrliche
...
cp -f "$SRC_DIR/frontend/LATEST_BUILD.json" "$FRONTEND_DIR/" 2>/dev/null || true
