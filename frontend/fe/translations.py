...
TRANSLATIONS = {
    ...
    "secret_origin_theme_gbc": {"en": "Origin: cheat menu code from Space Invaders (Game Boy Color)",
                                "de": "Herkunft: Cheat-Menue-Code aus Space Invaders (Game Boy Color)"},
    ...
    "help_nav_select_desc": {"en": "Also: one level back / exit dialog (same as Back)",
                             "de": "Ebenfalls: eine Ebene zurueck / Beenden-Dialog (wie Zurueck)"},
    ...
    "help_playing_reset_desc": {"en": "Reset the running core, without reloading it "
                                ...
                                "de": "Laufenden Core zuruecksetzen, ohne ihn neu zu laden "
    ...
    "help_general_music_desc": {"en": "Next music track (menu only)",
                                "de": "Naechster Musiktitel (nur im Menue)"},
    ...
    "sys_swap_ok_back_off": {"en": "Swap Confirm/Cancel: OFF -> turn on",
                             "de": "Bestaetigen/Abbrechen vertauschen: AUS -> einschalten"},
    "sys_swap_ok_back_on": {"en": "Swap Confirm/Cancel: ON -> turn off",
                            "de": "Bestaetigen/Abbrechen vertauschen: AN -> ausschalten"},
    ...
    "sys_system_bg_on": {"en": "System backgrounds: ON -> turn off (missing cover art shows plain box instead)",
                         "de": "System-Hintergrundbilder: AN -> ausschalten (fehlendes Cover zeigt dann nur eine Flaeche)"},
    ...
    "sys_fast_scroll_off": {"en": "Fast scroll: OFF -> turn on (trades a small tearing risk for less scroll delay)",
                            "de": "Schnelles Scrollen: AUS -> einschalten (etwas Bildriss-Risiko gegen kuerzere Scroll-Verzoegerung)"},
    ...
    "remap_action_back_fe": {"en": "Back to frontend (from MiSTer menu)",
                             "de": "Zurueck ins Frontend (aus dem MiSTer-Menue)"},
