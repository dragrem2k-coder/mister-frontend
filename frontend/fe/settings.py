...
# ENTFERNT (Build 102). Hier stand der Schalter fuer das
# Scroll-Blitting aus Build 96, zusammen mit der ausfuehrlichen
# Begruendung, warum er trotz enttaeuschender Messung erst einmal drin
# blieb: "Die Entwicklungsumgebung ist nicht das Geraet. Bestaetigt
# sich die Messung dort, gehoert der ganze Pfad geloescht."
#
# Er hat sich bestaetigt - auf dem Geraet wie hier. Nachgemessen in
# allen drei Aufloesungen kostet das Verschieben mehr, als es spart
# (CRT 0.50 -> 0.65 ms, 720p 1.25 -> 1.63 ms, HDMI 2.04 -> 2.84 ms).
# Der Grund steht ausfuehrlich an der Stelle in frontend.py, an der
# der Pfad frueher aufgerufen wurde. Mit dem Schalter faellt auch das
# flache Vignetten-Band weg, das nur seinetwegen existierte.
